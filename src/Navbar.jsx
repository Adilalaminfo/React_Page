...
const Navbar= ()=>{
  ...
  <div className="container-fluid">
    <NavLink className="navbar-brand" to="/">Md Adil Technical</NavLink>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav  ml-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          ...
          exact className="nav-link" to="/service">Service</NavLink >
        </li>
         <li className="nav-item">
          <NavLink activeClassName='menu-active' 
          exact className="nav-link" to="/about">About</NavLink >
                ...
                <li className="nav-item">
          <NavLink activeClassName='menu-active'  
           exact className="nav-link" to="/contact">Contact</NavLink >
        </li>
        </ul>
		    </div>
		  </div>
